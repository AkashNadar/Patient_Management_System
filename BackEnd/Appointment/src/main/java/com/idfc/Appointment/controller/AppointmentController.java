...
public class AppointmentController {
	...
	@GetMapping("/getAppointmentByDoctorEmail/{doctorEmail}")
	public ResponseEntity<Object> getAppointmentByDoctorEmail(@RequestParam String doctorEmail){
		Appointment res = this.service.getAppointmentByDoctorEmail(doctorEmail);
		if(res == null) {
			return new ResponseEntity<Object>("Appointment not found", HttpStatus.NOT_FOUND);
		}
