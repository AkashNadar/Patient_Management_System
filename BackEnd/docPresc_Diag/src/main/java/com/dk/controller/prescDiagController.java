...
public class prescDiagController {
	...
	@Autowired
	private prescDiagServiceImple service;
	
	@PostMapping("/addPatient")
	public ResponseEntity<Object> addUser(@RequestBody prescDiag prescdiag){
		prescDiag resPrescDiag = this.service.addPrescription(prescdiag);
	...
	public ResponseEntity<Object> getAllUsers(){
		List<prescDiag> users = this.service.getPrescDiag();
